...
export default function ScienceModule() {
  const module = MODULES.find((m) => m.id === 'science')!;
  ...
  return (
    <motion.div
      ...
      className="min-h-screen bg-gradient-to-b from-green-100 to-green-50 p-6"
    >
          ...
          {module.activities.map((activity, index) => {
            ...
            return (
              <motion.button
                ...
                className="bg-white rounded-2xl p-5 shadow-md hover:shadow-lg text-left transition-shadow border-2 border-transparent hover:border-green-200"
              >
